...
export default function PestControlPage() {
  const heroImage = PlaceHolderImages.find((img) => img.id === 'hero-pests');
  const pestsSectionImage =
    PlaceHolderImages.find((img) => img.id === 'service-pests') ?? heroImage;

  const pestInfoByName: Record<
    string,
    { summary: string; signs: string; risks: string; treatment: string; category: 'insects' | 'rodents' | 'wood' }
  > = {
    Ants: {
      category: 'insects',
      summary: 'Persistent trails and repeat activity around food and moisture.',
      signs: 'Visible trails, small piles of soil, and activity near sinks or pantries.',
      risks: 'Food contamination and rapid colony growth if the nest isn’t addressed.',
      treatment: 'Targeted baiting + perimeter barriers and entry-point sealing.',
    },
    Spiders: {
      category: 'insects',
      summary: 'Webbing and sightings in corners, basements, and garages.',
      signs: 'Webs, egg sacs, and increased sightings around lights or clutter.',
      risks: 'Most are harmless, but bites are possible and indicate other pests nearby.',
      treatment: 'Reduce harborage + targeted treatment and prevention around entry points.',
    },
    Cockroaches: {
      category: 'insects',
      summary: 'Hardy indoor pests that thrive in warmth, moisture, and crumbs.',
      signs: 'Pepper-like droppings, egg cases, musty odor, and nighttime activity.',
      risks: 'Can spread bacteria and trigger allergies/asthma.',
      treatment: 'Gel baits + growth regulators, sanitation guidance, and exclusion.',
    },
    Crickets: {
      category: 'insects',
      summary: 'Noisy at night and often attracted to moisture and warm spaces.',
      signs: 'Chirping, sightings in basements/garages, and minor fabric/paper damage.',
    ...
    Mice: {
      ...
      risks: 'Disease exposure, food contamination, and electrical/fire hazards.',
      treatment: 'Trapping + exclusion work to close entry points and prevent return.',
    },
    Rats: {
      category: 'rodents',
      summary: 'Stronger, more destructive rodents often linked to outdoor access.',
      ...
      treatment: 'Baiting/trapping strategy + exterior exclusion and habitat changes.',
    },
    Earwigs: {
      category: 'insects',
      summary: 'Often show up after rain—drawn to damp areas around foundations.',
    ...
    Silverfish: {
      ...
      signs: 'Damage to books/paper, shed skins, and sightings in bathrooms or basements.',
    ...
    Moths: {
      ...
      signs: 'Holes in fabrics, webbing in corners, or larvae near stored foods.',
      risks: 'Damage to clothing, carpets, and pantry goods.',
      treatment: 'Targeted treatment + storage/cleaning guidance and monitoring traps.',
    },
    Centipedes: {
      category: 'insects',
    ...
    Millipedes: {
      category: 'insects',
      summary: 'Often wander indoors when conditions outside are too wet or dry.',
      signs: 'Slow-moving pests near doors/windows; curled bodies if they die indoors.',
      risks: 'Nuisance and moisture-related entry pathways.',
      treatment: 'Exterior habitat adjustments + sealing and perimeter protection.',
    },
    Termites: {
      category: 'wood',
      summary: 'Wood-destroying pests that can cause expensive hidden damage.',
      signs: 'Mud tubes, hollow-sounding wood, shed wings, or swarmers seasonally.',
      risks: 'Structural damage if left untreated.',
      treatment: 'Inspection + targeted treatment plan (baiting or localized solutions).',
    },
  };
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-24">
              <div className="relative overflow-hidden rounded-2xl border bg-secondary shadow-xl">
                <div className="relative aspect-[4/5]">
                  {pestsSectionImage && (
                    <Image
                      src={pestsSectionImage.imageUrl}
                      alt={pestsSectionImage.description}
                      fill
                      className="object-cover"
                      sizes="(max-width: 1024px) 100vw, 40vw"
                      data-ai-hint={pestsSectionImage.imageHint}
                    />
                  )}
              ...
              <div className="mt-4 grid grid-cols-3 gap-3">
                ...
                <div className="rounded-xl border bg-background p-4">
                  ...
                  <p className="text-xs text-muted-foreground">Family-safe focus</p>
                </div>
                <div className="rounded-xl border bg-background p-4">
                  <p className="text-2xl font-bold">Plan</p>
                  <p className="text-xs text-muted-foreground">Prevent return</p>
                </div>
              </div>
            </div>
                            ...
                            <div className="flex items-start justify-between gap-4">
                              <div className="flex items-start gap-3">
                                ...
                                <div className="min-w-0">
                                  <p className="font-bold text-lg">{pest.name}</p>
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="max-w-[700px] mx-auto text-muted-foreground md:text-lg">
              A simple yet effective three-step plan to keep your home protected.
            </p>
          </div>
                  ...
                  <div className="grid lg:grid-cols-12">
                    <div className="lg:col-span-4 border-b lg:border-b-0 lg:border-r bg-gradient-to-br from-secondary to-background p-6">
                      ...
                      <div className="mt-6 rounded-xl border bg-background p-4">
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                          Clear plan, targeted treatment, and prevention focused on
                          keeping pests out.
                        </p>
                      </div>
                    </div>
